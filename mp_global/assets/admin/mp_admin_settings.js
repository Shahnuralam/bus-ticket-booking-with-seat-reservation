...
(function ($) {
    ...
    $(document).on(
        "click",
        ".mp_add_icon_image_area button.mp_icon_add",
        function () {
            let target_popup = $(".mp_add_icon_popup");
            target_popup.find(".iconItem").click(function () {
                let parent = $("[data-active-popup]").closest(
                    ".mp_add_icon_image_area"
                );
    ...
    $(document).on(
        "click",
        ".mp_add_icon_image_area .mp_icon_remove",
        function () {
    ...
    $(document).on(
        "click",
        ".mp_add_icon_image_area .mp_image_remove",
        function () {
            let parent = $(this).closest(".mp_add_icon_image_area");
            parent.find('input[type="hidden"]').val("");
